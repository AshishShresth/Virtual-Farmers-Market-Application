...
@section('content')
    ...
    <form method="post"  action="{{ route('posts.update', $post->id) }} " enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-group" value="{{$post->quantity}}" name="quantity" id="quantity" />
        </div>
        <div class="form-group">
            <label for="price_per_kg">Price per Kilogram</label>
            <input type="number" class="form-group" value="{{$post->price_per_kg}}" name="price_per_kg" id="price_per_kg" />
        </div>
        <div class="form-group">
