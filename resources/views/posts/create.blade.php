    ...
    <div class="container mb-5 border bg-light p-5 col-md">
        ...
        <form method="post"  action="{{ route('posts.store') }} " enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('product_name') is-invalid @enderror"  name="product_name" id="product_name" placeholder="Product name"/>
                @error('product_name')
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="date_of_harvest" id="date_of_harvest"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="product_description" cols="20" rows="5" placeholder="Body Text"></textarea>
            </div>
            <div class="form-group">
